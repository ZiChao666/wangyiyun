<template>
  ...
  <div class="detailTop">
    <div class="detailTopLeft">
      <svg class="icon liebiao" aria-hidden="true" @click="UPDATElyricShow">
    ...
    <div class="detailTopRight">
      <svg class="icon liebiao" aria-hidden="true">
        <use xlink:href="#icon-get"></use>
      </svg>
    </div>
  </div>
  <div class="detailContent" v-show="!isLrcListShow">
    <img src="@/assets/needle-ab.png" alt="" class="img_needle" :class="{ img_needle_active: !isBtnShow }" />
    <img src="@/assets/cd.png" alt="" class="img_cd" />
    <img :src="musicList.al.picUrl" alt="" class="img_ar" @click="isLrcListShow = true" :class="isBtnShow ? 'img_ar_pauesd' : 'img_ar_active'" />
  </div>
  <div class="musicLyric" ref="musicLyric" v-show="isLrcListShow" @click="isLrcListShow = false">
...
export default {
  ...
  methods: {
    ...mapMutations(['UPDATElyricShow', 'UPDATEPlayListIndex']),
    goPlay(num) {
  ...
  computed: {
    ...mapState(['lrcList', 'currentTime', 'playListIndex', 'playList', 'duration']),
    lyric() {
      let arr
      if (this.lrcList.lyric) {
        arr = this.lrcList.lyric.split(/[(\r\n)\r\n]+/).map((item, i) => {
